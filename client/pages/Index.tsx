...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-[#84C4FF] text-white overflow-x-hidden">
      ...
      <section id="hero" className="relative min-h-screen px-4 sm:px-6 lg:px-20 pt-24 lg:pt-32 pb-12 lg:pb-20">
        <div className="absolute right-0 top-0 w-full lg:w-1/2 h-full opacity-5 lg:opacity-10">
          <div className="grid grid-cols-8 lg:grid-cols-12 gap-1 h-full">
            {Array.from({length: 400}).map((_, i) => (
              <div key={i} className="h-0 border-t border-white/10 animate-pulse" style={{animationDelay: `${i * 10}ms`}}></div>
            ))}
          </div>
        </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className={`space-y-6 lg:space-y-8 transform transition-all duration-1000 delay-300 ${
                ...
                <p className="text-black text-base sm:text-lg lg:text-xl max-w-md font-inter leading-relaxed">
                  Your Vision, Our Experience With 20+ years in the industry, we've served 50,000+ satisfied customers and delivered 30+ successful projects that speak for themselves.
                </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div className={`space-y-6 lg:space-y-8 transform transition-all duration-1000 ${
              ...
              <blockquote className="text-black text-base sm:text-lg font-poppins leading-relaxed">
                "When I founded JGRt Group over two decades ago, my vision was simple – to create buildings that stand not just as structures, but as legacies of trust, quality, and innovation. Today, seeing our journey of 20+ years, 50,000+ happy customers, and over 30 landmark projects, I feel proud that our commitment has never wavered.
                <br /><br />
                Our success is not measured merely in numbers, but in the smiles of our clients, the strength of our partnerships, and the value we bring to communities. At JGRt, we believe in continuous learning, adapting, and pushing boundaries to set new benchmarks in the building industry.
                <br /><br />
                As we step into the future, our promise remains the same – to build with integrity, deliver with excellence, and grow with our people."
              </blockquote>
            ...
            <div className={`space-y-12 lg:space-y-16 transform transition-all duration-1000 delay-300 ${
              isVisible.founder ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'
            }`}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 lg:gap-8">
                {[
                  ...
                  <div key={index} className={`space-y-3 transform transition-all duration-700 ${
      ...
      <section id="dreamhouse" className="px-4 sm:px-6 lg:px-20 py-12 lg:py-20">
        <div className="max-w-[1422px] mx-auto">
          <div className={`relative transform transition-all duration-1000 ${
            isVisible.dreamhouse ? 'scale-100 opacity-100' : 'scale-95 opacity-0'
          }`}>
      ...
      <section id="properties" className="px-4 sm:px-6 lg:px-20 py-12 lg:py-20 bg-black/80 relative overflow-hidden">
        <div className="max-w-[1422px] mx-auto">
          <div className="absolute left-0 right-0 flex justify-between px-4 sm:px-6 lg:px-20 opacity-20">
            {Array.from({length: 11}).map((_, i) => (
              <div key={i} className="w-px h-full bg-gradient-to-b from-white/10 to-black/10"></div>
            ))}
          </div>

          <div className="relative">
            <div className={`flex flex-col lg:flex-row justify-between items-start lg:items-center mb-12 lg:mb-16 gap-6 transform transition-all duration-1000 ${
              isVisible.properties ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
            }`}>
              <h2 className="text-3xl sm:text-4xl lg:text-[44px] font-medium font-poppins">Recent Properties</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6">
                      <div className="space-y-3 lg:space-y-4">
                        <div className="flex items-center gap-3">
                          <img src="/projectarea.png" alt="Area" className="w-6 sm:w-8 h-6 sm:h-8" />
                          <div>
                            <p className="font-medium text-sm sm:text-base">Project Area:</p>
                            <p className="font-light text-sm sm:text-base">{property.area}</p>
                          </div>
                        </div>
                        
                        <div className="flex items-center gap-3">
                          <img src="/rate.png" alt="Units" className="w-6 sm:w-8 h-6 sm:h-8" />
                          <div>
                            <p className="font-medium text-sm sm:text-base">Total Units:</p>
                            <p className="font-light text-sm sm:text-base">{property.units}</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3 lg:space-y-4">
                        <div className="flex items-center gap-3">
                          <img src="/rate.png" alt="Rate" className="w-6 sm:w-8 h-6 sm:h-8" />
                          <div>
                            <p className="font-medium text-sm sm:text-base">Rate Per Sqft:</p>
                            <p className="font-light text-sm sm:text-base">{property.rate}</p>
                          </div>
                        </div>
                        
                        <div className="flex items-center gap-3">
                          <img src="/size.png" alt="Size" className="w-6 sm:w-8 h-6 sm:h-8" />
                          <div>
                            <p className="font-medium text-sm sm:text-base">Plot Sizes:</p>
                            <p className="font-light text-sm sm:text-base">{property.plotSizes}</p>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <section id="whychoose" className="px-4 sm:px-6 lg:px-20 py-12 lg:py-20 bg-black/40">
        <div className="max-w-[1422px] mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className={`space-y-12 lg:space-y-16 transform transition-all duration-1000 ${
              isVisible.whychoose ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'
            }`}>
              <h2 className="text-3xl sm:text-4xl lg:text-[44px] font-medium font-poppins">Why Choose Us?</h2>
      ...
      <footer id="footer" className="bg-[#82C8E5] px-4 sm:px-6 lg:px-20 py-12 lg:py-16 relative overflow-hidden">
        <div className="max-w-[1422px] mx-auto">
          ...
          <div className={`relative text-center space-y-6 lg:space-y-8 transform transition-all duration-1000 ${
            ...
            <div className="border-t border-white/20 pt-6 lg:pt-8">
              <nav className="flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-8 xl:gap-16 text-white font-jakarta text-base sm:text-lg lg:text-xl">
                {['HOME', 'ABOUT', 'PROPERTIES', 'CAREER', 'CONTACT'].map((link, index) => (
